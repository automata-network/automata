...
use sp_runtime::traits::{
    BlakeTwo256, Block as BlockT, Convert, Extrinsic, NumberFor, SaturatedConversion, StaticLookup,
    Verify,
};
use sp_runtime::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("finitestate"),
    impl_name: create_runtime_str!("finitestate"),
    authoring_version: 1,
...
parameter_types! {
    ...
    pub const SS58Prefix: u16 = 13107;
}
...
parameter_types! {
    pub const BridgeChainId: u8 = 254;
...
parameter_types! {
    pub const BridgeTokenId: [u8; 32] = hex_literal::hex!("0000000000000000000000907f34dd7caD6e8752dDaCF365aa25c7FA701dd903");
