...
pub use pallet_stake::{AutomataOffence, AutomataReportOffence, GeodeIdd, Kind, SlashParms};
...
impl<Offender: Clone> AutomataOffence<Offender> for GeodeOffence<Offender> {
    ...
    fn slash(&self, offline_time: u32, _total_offline: u32, _param: SlashParms) -> Perbill {
