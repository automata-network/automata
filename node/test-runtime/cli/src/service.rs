...
use automata_test_runtime::RuntimeApi;
...
pub fn new_full_base(mut config: Configuration) -> Result<NewFullBase, ServiceError> {
    ...
    let (rpc_extensions_builder, rpc_setup) = {
        ...
        let rpc_extensions_builder = move |deny_unsafe, subscription_executor| {
            ...
            let deps = automata_test_rpc::FullDeps {
                client: rpc_client.clone(),
                pool: rpc_transaction_pool.clone(),
                deny_unsafe,
                grandpa: automata_test_rpc::GrandpaDeps {
            ...
            automata_test_rpc::create_full(deps, subscription_task_executor.clone())
        };
...
> {
    ...
    let light_deps = automata_test_rpc::LightDeps {
    ...
    let rpc_extensions = automata_test_rpc::create_light(light_deps);
